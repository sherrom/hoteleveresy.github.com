        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="messages.php"><i class="fa fa-desktop"></i> Answer</a>
                    </li>
					<li>
                ...
                <div class="col-md-12">
                    <div class="jumbotron">
						...
						<div class="panel-body">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Answer the customer questions</h4>
                                        </div>
										<form method="post">
							...
							if(isset($_POST['log']))
							{	
								$log ="INSERT INTO `newsletterlog`(`title`, `subject`, `ans`) VALUES ('$_POST[title]','$_POST[subject]','$_POST[ans]')";
